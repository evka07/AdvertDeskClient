...
export const fetchAds = () => {
    return dispatch => {
        ...
        return axios.get('http://https://f94ae564-3619-4341-99fe-1707eb482fdb-00-atl29fq4qf1y.kirk.replit.dev/ads')
            .then(response => {
...
export const createAd = (adData) => {
    return dispatch => {
        ...
        return axios.post('http://https://f94ae564-3619-4341-99fe-1707eb482fdb-00-atl29fq4qf1y.kirk.replit.dev/ads/create', adData)
            .then(response => {
...
export const updateAd = (id, adData) => {
    return dispatch => {
        ...
        return axios.put(`http://https://f94ae564-3619-4341-99fe-1707eb482fdb-00-atl29fq4qf1y.kirk.replit.dev/ads/${id}`, adData)
            .then(response => {
...
export const deleteAd = (id) => {
    return dispatch => {
        ...
        return axios.delete(`http://https://f94ae564-3619-4341-99fe-1707eb482fdb-00-atl29fq4qf1y.kirk.replit.dev/ads/${id}`)
            .then(response => {
...
export const loginUser = (username, password) => {
    return dispatch => {
        ...
        return axios.post('http://https://f94ae564-3619-4341-99fe-1707eb482fdb-00-atl29fq4qf1y.kirk.replit.dev/login', { username, password })
            .then(response => {
...
export const registerUser = (username, password) => {
    return dispatch => {
        ...
        return axios.post('http://https://f94ae564-3619-4341-99fe-1707eb482fdb-00-atl29fq4qf1y.kirk.replit.dev/register', { username, password })
            .then(response => {
